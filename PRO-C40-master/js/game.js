    ...
    play(){
                ...
                Player.getPlayerInfo();
                 ...
                 for(var plr in allPlayers){
                     ...
                     text(allPlayers.player1.score , 290,50)
                     
                     text(allPlayers.player2.score , 290 , 100)
                     
                     textSize(30)
                     text(allPlayers.player2.name + "'s score:" ,50,100 )
                     text(allPlayers.player1.name + "'s score:", 50 ,50)
